...
##########
##From CL's v1
##RKv1: changed directory to lski2753 specific, commented out unused variable
# check the following variables to make sure they are correct

# for Project_11192_H_flyu using CUT-RUNTools-2.0 parameters for trimmomatic and bowtie2

folder=$( dirname $0 )
project=$( basename $folder )
serverFolder=/Volumes/sunlab/SeqData/RNA/$project
genome=/Users/kimh7/SeqTools/genomesannotations/bowtie2index/UCSC.mm10/UCSC_mm10_bowtie2_20200605_index
adaptorFilePath=/Users/kimh7/SeqTools/Trimmomatic-0.39/adapters/TruSeq3-PE-2.fa
spikeingenome=/Users/kimh7/SeqTools/genomesannotations/bowtie2index/sacCer3/sacCer3_bowtie2_20220405_index

# Make sure serverFolder is correct and that file exists #####################

# if [ ! -d ${serverFolder} ]; then
#    echo "Cannot find the following folder: ${serverFolder}"
#    exit
# fi

# Run FastQC on untrimmed ####################################################
# Skip untrimmed fastQC since this will be the same as in Projetc_11192_H_RKtry
...
java -jar /Users/kimh7/SeqTools/Trimmomatic-0.39/trimmomatic-0.39.jar PE \
	-threads 20 \
	$F1 \
	$F2 \
...
do
    ...
    java -jar /Users/kimh7/SeqTools/picard-2.23.0/picard.jar MarkDuplicates \
